...
class CustomCardUpComing extends StatelessWidget {
  const CustomCardUpComing({super.key, required this.dose});
        ...
        children: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: AppTextStyles.s12.w300.brownDarker,
                  ),
                ),
              ],
            ),
          ...
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(dose.name, style: AppTextStyles.s16.w500.primaryNormal),
                const Icon(
