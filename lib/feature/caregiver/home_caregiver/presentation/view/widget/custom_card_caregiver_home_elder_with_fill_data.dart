...
class CustomCardCaregiverHomeElderWithFillData extends StatelessWidget {
  const CustomCardCaregiverHomeElderWithFillData({
    super.key,
    required this.data,
  });
              ...
              Expanded(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(24.r),
                    border: Border.all(
                      color: AppColor.subtextLightActive,
                      width: 1.r,
                    ),
                  ),
                  child: Column(
                    children: [
                      Text(
                        'آخر سكر',
                        style: AppTextStyles.s12.w400.subTextNormal,
                      ),
                      const RSizedBox(height: 8),
                      Text(
                        data.lastSugar.value.toString(),
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const RSizedBox(height: 8),
                      Text(
                        '${data.lastPressure.sys}/${data.lastPressure.dia}',
                        style: AppTextStyles.s20.w600.primaryNormal,
                      ),
                    ],
                  ),
