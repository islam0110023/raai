...
class CustomBottomNavBarCaregiver extends StatelessWidget {
  const CustomBottomNavBarCaregiver({
    super.key,
    required this.controller,
    required this.state,
  });
  final BottomNavCaregiverCubit controller;
  final BottomNavCaregiverCubit state;
